...
const ICONS = {
  ...
  bottle: (
    <>
      <path d="M11 3.5h2v2.4l1.1 1.7a3 3 0 0 1 .5 1.65V19a1.5 1.5 0 0 1-1.5 1.5h-2.2A1.5 1.5 0 0 1 9.4 19V9.25a3 3 0 0 1 .5-1.65L11 5.9z" />
      <path d="M9.6 12.4h4.8" />
    </>
  ),
  beer: (
    <>
      <path d="M7 8.5h7.2v9A1.5 1.5 0 0 1 12.7 19H8.5A1.5 1.5 0 0 1 7 17.5z" />
      <path d="M14.2 10.5h2.4a1.3 1.3 0 0 1 1.3 1.3v2.4a1.3 1.3 0 0 1-1.3 1.3h-2.4" />
      <path d="M8.6 8.4V6.7M11 8.4V6.5M12.9 8.4V6.9" />
    </>
  ),
  cigar: (
    <>
      <path d="M4 13.7h12.6a2.35 2.35 0 0 0 0-4.7H8.3" />
      <path d="M17 9.2c1.3.35 2.2 1.3 2.2 2.15S18.3 13.35 17 13.7" />
      <path d="M6.4 11.35h7.4" />
    </>
  ),
  calendar: (
    <>
